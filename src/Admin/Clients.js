      ...
      return (        
        <div>
          ...
          <div className="parent">
            ...
            <div className = "main">
            <h1 className="title">Lista Zarejestrowanych Klientów:</h1>
            <div className="table-container">
              <table className="user_list">
                {this.state.users.map(service => (
                  <div key={service.start_date} className="div-list">
                    <tr className="kid_info">
                      <td>{service.name} {service.surname} {service.email}</td>
                      {/* <td><a class="link" href={"/ServiceDetail?service_id=" + service.id}><button>Szczegóły</button></a></td> */}
                    </tr>
                  </div>
                ))}
              </table>
